...
import { SuiLogo } from "@/(auth)/_components/MobileAuth";
...
sm:flex
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-teal-500 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
      ...
      <div className="relative flex items-center gap-2">
        {isLoading ? (
          ...
          <>
            ...
            <SuiLogo className="w-5 h-5 stroke-white" />
            {/* </div> */}
