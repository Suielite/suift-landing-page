          ...
          <div className="w-full flex   flex-col h-full justify-between">
            ...
            <div className="w-full  px-10   flex justify-center">
              <span
                style={{
                  borderImage:
                    "linear-gradient(to right, rgba(20, 15, 42, 0) 0%, rgba(255, 255, 255, 1), rgba(255, 255, 255, 1), rgba(20, 15, 42, 0)) 1",
                }}
                className="text-[25px] border-t text-center pt-5 text-white font-medium"
              >
                {name}
              </span>
            </div>
